...
/**
 * Date Picker class
 * TODO: Removed unused $this->args
 */
class WC_Bookings_Extensions_Bookings_Date_Field extends WC_Bookings_Extensions_Bookings_Picker {

	private $field_type = 'date-field';
